...
class Block {
  constructor(index, timestamp, previousHash, hash, nonce, data) {
    this.index = index;
...
/*hash block method.*/
Blockchain.prototype.hashBlock = function (index, previousHash, nonce, timestamp, data) {
  return CryptoJS.SHA256(index + previousHash + nonce + timestamp + JSON.stringify(data)).toString();
}

/*Proof Of Work method.*/
Blockchain.prototype.proofOfWork = function (previousHash, data) {
  let nonce = 0;

...
const privateKeyLocation = 'data/private_key';

const getPrivateFromWallet = () => {
  const encrypted = readFileSync(privateKeyLocation, 'utf8');
  const privateKey = CryptoJS.AES.decrypt(encrypted, config.PASS).toString(CryptoJS.enc.Utf8);
...
const initWallet = () => {
  ...
  if (!existsSync(privateKeyLocation)) {
    ...
    const encrypted = CryptoJS.AES.encrypt(newPrivateKey, config.PASS);
